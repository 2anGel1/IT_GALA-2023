                        ...
                        <div class=" py-4  my-4 ">
                            ...
                            <form  style="" action="{{ route('admin.ticket.store.tse',null,false) }}" class="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="grid md:grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-2 pt-0 mb-3">
                                        <label class="font-bold "> Profession </label>
                                        <input type="text" placeholder="Profession de la personne"   name='profession' value="{{old("profession")}}"
                                        class="relative w-full px-3 py-2 text-sm text-gray-600 placeholder-gray-400 bg-white border-gray-400 rounded outline-none focus:border-coolGray-400 focus:outline-none focus:ring-coolGray-100" />
                                        @error('profession')
                                                <div class="text-sm font-thin text-center text-red-600">{{ $errors->first('profession') }}  </div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class=" col-span-2 pt-0 mb-3">
                                        ...
                                        <input type="text" disabled value="Personne externe à l'ESATIC"
