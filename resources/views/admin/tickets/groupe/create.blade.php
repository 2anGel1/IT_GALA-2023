                            ...
                            <form  style="" action="{{ route('groupe.store') }}" class="" method="post">
                                ...
                                <div class="flex gap-6">
                                    ...
                                    <div class="col-span-4 pt-0 mb-3 mx-auto">
                                        ...
                                        <input type="text" placeholder="Nom du groupe"   name='libelle' value="{{old("libelle")}}"
                                ...
                                <div class="col-span-2 flex justify-center">
                                    <div class="">
                                        <button class="px-4 py-2 mt-5 font-bold text-white bg-gray-600 rounded-md">  Enregistrer </button>
                                    </div>
                                </div>
